All patches in this direcorty for JDK >= 1.5.x are governed by the Java
Research License and require a 'Readme' file to be present on any distribution
medium.  You must read and agree to its terms as stated below:

Use and distribution of this technology is subject to the
